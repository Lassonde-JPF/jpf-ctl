...
The class [Account](code/jpf-ctl/src/main/java/example/Account.java) models a bank account.  The classes [Withdraw](code/jpf-ctl/src/main/java/example/Withdraw.java) and [Deposit](code/jpf-ctl/src/main/java/example/Deposit.java) are threads that withdraw and deposit one dollar from a bank account.  
