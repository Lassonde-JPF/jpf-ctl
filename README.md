...
The class [Account](code/jpf-ctl/src/main/java/example/Account.java) models a bank account.  The classes [Withdraw](code/jpf-ctl/src/main/java/example/Withdraw.java) and [Deposit](code/jpf-ctl/src/main/java/example/Deposit.java) are threads that withdraw from and deposit to a bank account.  The class [Main](code/jpf-ctl/src/main/java/example/Main.java) is an app that creates a single bank account and multiple threads that withdraw from the deposit to that bank account.  It takes three command line arguments:
