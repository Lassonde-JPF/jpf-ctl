...
/**
 * This class represents an LTL formula that is a disjunction (or) of two formulas.
 * 
...
public class Or extends Formula {
	...
	/**
	 * Initializes this LTL formula as the disjunction (or) of the given {@code left} and {@code right} subformulas.
	 * 
