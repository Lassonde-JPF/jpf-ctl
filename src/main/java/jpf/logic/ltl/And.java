...
/**
 * This class represents an LTL formula that is a conjunction (and) of two formulas.
 * 
...
public class And extends Formula {
	...
	/**
	 * Initializes this LTL formula as the conjunction (and) of the given {@code left} and {@code right} subformulas.
	 * 
